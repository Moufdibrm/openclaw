...
Code and git work route to Tony by default. Tony may inspect partial platforms to develop or audit tool integrations, but business action still belongs to the owning agent or route.
